...
const BlogsController = {
    ...
    getAllBlogs: async () => {
        return ResponseObj(200, "success", await BlogsService.getAllBlogs());
    },
    ...
    getListBlogs: async () => {
        ...
        return ResponseObj(200, "success", blogRs);
    },
    ...
    createBlog: async (blog) => {
        ...
        try{
            ...
            return ResponseObj(200, "success", blog);
        }
        catch(err){
    ...
    updateReaction: async (body) => {
        ...
        try{
            ...
            return ResponseObj(200, "success", blog.reactions);
        }
        catch(err){
